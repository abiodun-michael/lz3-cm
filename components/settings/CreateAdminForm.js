...
const handleFinish = (input)=>{
    ...
    inviteAdmin({variables:{name,email,phone,permission:{role,permission:"CHURCH"}}})
}
            ...
            <Drawer width={450} visible={open} title="Add Manager">
                <Form layout="vertical" 
                    ...
                    <Item label="Name" name="name" 
                        ...
                        <Input placeholder="e.g. Abiodun Michael"/>
                    </Item>
                    ...
                    <Item label="Phone" name="phone"
                        ...
                        <Input type="tel" placeholder="e.g 2348181842799"/>
                    </Item>
